...
Route::group(['middleware' => 'web', 'namespace' => 'Home'], function () {
    ...
    //搜索
    Route::get('search.html','IndexController@search');
    //分类下的文章
    Route::get("typelist/{id}", "IndexController@typelist");
    //归档下的文章
    Route::get("inbox/{year}/{month}.html","IndexController@inbox");
    //标签下的文章
    Route::get("logout/{id}", "IndexController@logout");
    //友情链接
    Route::get("link.html","IndexController@link");
...
Route::group(["namespace" => "Admin", "prefix" => "Admin", "middleware" => "usercheck"], function () {
    ...
    Route::group(["prefix" => "page"],function (){
        //页面列表
        Route::get("/","ContentController@page");
        //添加页面
        Route::get("add","ContentController@addpage");
        Route::post("add","ContentController@addpage");
        //修改页面
        Route::get("edit/{id}","ContentController@editpage");
        Route::post("edit/{id}","ContentController@editpage");
        //软删除
        Route::get("destroy/{id}","ContentController@destroypage");
        //恢复软删除
        Route::get("restore/{id}","ContentController@restorepage");
        //彻底删除
        Route::get("delete/{id}","ContentController@delpage");
    });
    //评论
    ...
    Route::group(["prefix" => "link"],function (){
        ...
        Route::post("edit/{id}","LinkController@edit");
        //删除
