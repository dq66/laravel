                ...
                <div class="cardContent">
                    <div class="mdui-typo">
                        ...
                        <div style="margin-bottom: 10px">
                            ...
                            分类：<a></a><a href="/typelist/{{$con->metas->id}}.html">{{$con->metas->types}}</a>
                        </div>
    ...
    <div class="right-pageTagMenu mdui-col-md-3 mdui-col-offset-md-1">
        <div class="vBox">
            <div class="control shadow-2">
                <div class="search">
                    <div class="searchBtn justCenter" style="opacity: 1;">
                        <i class="mdui-icon material-icons">search</i>
                    </div>
                    <div class="searchColor"></div>
                    <form action="/search.html" method="get">
                        <input type="text" name="data" placeholder="搜索内容" class="searchInput" autocomplete="off" disabled="disabled">
                    </form>
                </div>
                    ...
                    <div>
                        ...
                        <div class="tabCard">
                            ...
                            <ul>
                                @if(isset($metas))
                                    @foreach($metas as $me)
                                        <li><a href="/typelist/{{$me->id}}.html">{{$me->types}}</a>
                                            ({{$me->content_count}})
                                        </li>
                                    @endforeach
                                @else
