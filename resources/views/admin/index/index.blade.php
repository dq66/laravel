                ...
                <div id="submenu">
                    ...
                    <div class="sub-menu">
                        <ul class="layui-nav layui-nav-tree">
                            ...
                            <li class="layui-nav-item">
                                <a href="javascript:;" data-url="/Admin/page/add" data-title="撰写页面"> <i class="iconfont icon-xinjianyemiantianjia"></i>
                                    <span>撰写页面</span> </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="layui-nav layui-nav-tree">
                            <li class="layui-nav-item layui-nav-itemed">
                                ...
                                <dl class="layui-nav-child">
                                    ...
                                    <dd>
                                        <a href="javascript:;" data-url="/Admin/page/" data-title="页面管理"> <i
                                                    class="iconfont icon-wenzhang-copy"></i> <span>页面管理</span>
                                        </a>
                                    </dd>
                                    <dd>
                                        <a href="javascript:;" data-url="/Admin/link/" data-title="友情管理"> <i
                                                    class="iconfont icon-wenzhang-copy"></i> <span>友情管理</span>
                                        </a>
                                    </dd>
                                    <dd>
